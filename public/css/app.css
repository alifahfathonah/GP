...
@keyframes swing {
  ...
  .chiller-theme .sidebar-wrapper .sidebar-menu .sidebar-dropdown.active a i {
      color: #e4833b;
      text-shadow:0px 0px 10px rgba(228, 131, 59, 0.65);
  }
...
#myCarousel .carousel-item .mask img{-webkit-animation-name:slideInRight; animation-name:slideInRight; display:block; height:400px; max-width:100%;}
...
#myCarousel{position:relative; z-index:1; background:url('../storage/bg.jpg') center center no-repeat; background-size:cover; }
...
.banner-sec{background:url('../../storage/img/login-background.jpg')  no-repeat  bottom; background-size:cover;  border-radius: 0 10px 10px 0; padding:0;}
.container-reg{background:#fff; border-radius: 10px; box-shadow:15px 20px 0px rgba(0,0,0,0.1); width: 70%;margin-left:17%;}
...
.register-sec h2{margin-bottom:30px; font-weight:800; font-size:30px; color: #3f4c6b;}
...
.widget.widget-table .table {
  ...
  .widget .widget-header h3 {
    ...
    .card-inline-table .thumbnail-table {
      background: #000000;
      height: 120px;
    ...
    .card-inline-table .thumbnail-table img {
      display: block;
      width: 100%;
      height: 100%;
